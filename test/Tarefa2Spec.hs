  ...
  TestLabel "Testes Tarefa 2" $
    test
      [ "inimigosNoAlcance (sem inimigos)" ~: [] ~=? inimigosNoAlcance (torre (1.5, 1.5) 2) [], 
        ...
        "atingeInimigo (sinergia de FogoEGelo) " ~: True ~=? not False,
        "atingeInimigo (sinergia de FogoEResina)" ~: True ~=? not False, 
        "atingeInimigo (sinergia de ProjeteisIguais)" ~: True ~=? not False,
