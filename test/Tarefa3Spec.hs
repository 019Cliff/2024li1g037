  ...
  TestLabel "Testes Tarefa 3" $
    test
      [ 
        ...
        "atualizaInimigos" ~: [Inimigo {posicaoInimigo = (1.0,2.25), direcaoInimigo = Sul, vidaInimigo = 0.0, velocidadeInimigo = 0.25, ataqueInimigo = 10.0, butimInimigo = 50, projeteisInimigo = [Projetil {tipoProjetil = Gelo, duracaoProjetil = Finita 3.0},Projetil {tipoProjetil = Gelo, duracaoProjetil = Finita 3.0}]}] ~=? atualizaInimigos 5 mapa1 [inimigo4],
        "atualizaInimigo" ~: Inimigo {posicaoInimigo = (1.0,2.25), direcaoInimigo = Sul, vidaInimigo = 0.0, velocidadeInimigo = 0.25, ataqueInimigo = 10.0, butimInimigo = 50, projeteisInimigo = [Projetil {tipoProjetil = Gelo, duracaoProjetil = Finita 3.0},Projetil {tipoProjetil = Gelo, duracaoProjetil = Finita 3.0}]} ~=? atualizaInimigo 5 mapa1 inimigo4,
        ...
        "proximaDirecao" ~: Norte ~=? proximaDirecao mapa1 (1, 1) Sul,
        "moverInimigo" ~: Inimigo {posicaoInimigo = (1.0,2.0), direcaoInimigo = Norte, vidaInimigo = 0.0, velocidadeInimigo = 1.0, ataqueInimigo = 10.0, butimInimigo = 50, projeteisInimigo = [Projetil {tipoProjetil = Gelo, duracaoProjetil = Finita 3.0},Projetil {tipoProjetil = Gelo, duracaoProjetil = Finita 3.0}]} ~=? moverInimigo 1.0 mapa1 inimigo4,
